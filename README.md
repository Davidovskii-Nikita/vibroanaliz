...
**Во время отладки**, при просмотре значений черех последовательный порт **возможно уменьшение** производительности *ESP-01*.
...
**В процессе прошивки** устройства через браузер цикл прошивки может повториться, что может привести к неправильной прошивке *ESP-01*. В этом случае нужно **дождаться** конца прошивки и перезагрузки модуля. Так же, сайт , в котором, происходила отправка данных может уходить в бесконечную загрузку.
